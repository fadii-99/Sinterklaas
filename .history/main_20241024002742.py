...
ACCESS_TOKEN = "EAALyPvU2Hp4BO6lreynQzmc4HArKmVgfmZAZCa6vIOMdSI7w8MeYZB3ASuAEXPSbp06IEAtM3mKLWCwPJIfZAvYndob8ZAFs46rNbQsCqSQ4xxjDbER9EE38oZCcflvBbH8rSz4Txr9nFdAArEKNGaclHWxsN6WO3aQZBxRQQTJKfT0xRHF6kpl3X3ENJQSxBeDelkJCKucO5ZBThkwYPdzKNzJR3skZD"
...
def send_message(number, video):
    media_id = upload_video(video)

    if media_id:
        send_video_message(number, media_id)
...
def load_pending_video():
    ...
    if pending_video:
        ...
        if purchase:
            ...
            if send_message('923480952114','/home/fawad/Desktop/PYTHON/sinter_backend/static/generated_videos/final_sample_voice.mp4'):
                update_query = """
                    UPDATE final_videos 
