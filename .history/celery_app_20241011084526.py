...
from utils import update_video_status, get_pending_video, get_files_for_video, generate_video, update_purchase_status_to_in_progress
...
def process_pending_videos():
    ...
    try:
        ...
        if pending_purchase:
            ...
            final_video_path = generate_video(purchase_id, files, final_video_dir, db)


            update_video_status(db, purchase_id, 'completed')
