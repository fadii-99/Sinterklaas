...
class MediaProcessor:
    ...
    def create_pip_clip(self):
        ...
        if self.image_paths:
            ...
            pip_clip = ImageClip(rotated_image_path, transparent=True).set_duration(11.15).set_fps(24)
    ...
    def create_end_clip(self):
        ...
        end_text = TextClip("The End", fontsize=100, color='white', font='Amiri-Bold')
        ...
        # Add fade-in and fade-out effects to the end clip
        end_clip = end_clip.fx(vfx.fadein, 5).fx(vfx.fadeout, 2)
    ...
    def concatenate_final_video(self, final_clip, fv2_path, audio_duration):
        ...
        # Add the ending clip with transition effects
