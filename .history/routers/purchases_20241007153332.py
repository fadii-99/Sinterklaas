...
async def generate_voice_endpoint(text: str, background_tasks: BackgroundTasks):
    try:
        ...
        background_tasks.add_task(generate_voice, text, task_id, task_status)
...
@router.get("/whastapp/")
async def whastapp():
    send_whatsapp_video('+923480952114', 'WhatsApp Video 2024-09-29 at 2.14.44 PM.mp4' )
    return {"message": "WhatsApp endpoint is ready."}
