...
async def purchase_video(purchase: VideoPurchaseSchema, files: List[UploadFile] = File(...), db: Session = Depends(get_db)):
    try:
        ...
        image_paths = save_files(purchase.user_email, image_files, "images")
        video_paths = save_files(purchase.user_email, video_files, "videos")
        ...
        # Optional: Trigger payment creation or further processing
