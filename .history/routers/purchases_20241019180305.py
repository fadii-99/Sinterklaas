...
async def purchase_video(
    user_email: str = Form(...),
    receiver_phone: List[str] = Form(...),  # Expecting a list of phone numbers
    send_date: str = Form(...),
    video_name: str = Form(...),
    voice_path: str = Form(...),
    amount: float = Form(...),  # Ensure amount is treated as float or int
    files: List[UploadFile] = File(...),  # Accepting list of files
    name: str = Form(...),
    age: int = Form(...),  # Ensuring age is an integer
    hobby: str = Form(...),
