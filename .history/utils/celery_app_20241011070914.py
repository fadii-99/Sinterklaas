...
import os
from database import SessionLocal  # Assuming you have a function to get a db session
...
# Database functions with raw SQL
...
def process_pending_videos():
    db = SessionLocal()  # Explicitly create a new db session
    try:
        # Fetch a pending video (one at a time to avoid conflicts)
        ...
        if pending_purchase:
            ...
            # Mark purchase as 'in-progress' to avoid duplicate processing
            ...
            # Set the directory for generated videos
            ...
            # Save the generated video information
