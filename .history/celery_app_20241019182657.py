...
def process_pending_videos():
    ...
    try:
        ...
        # generated_audio = generate_voice(purchase_email, purchase_date, name, age, hobby )
        generated_audio = 'static/generated_audios/b6cbfc78-90eb-4aa6-9147-fb2398723639.mp3'
        ...
        final_video_path = generate_video(purchase_id, purchase_date, purchase_email, files, final_video_dir, connection)
